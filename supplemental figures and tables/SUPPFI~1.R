# This script is for a figure of Eq3 (rota, hib, pcv) AND figure of Eq7 (rota, hib, pcv)
...
# load scripts
load("Scripts - Aim 3/Output/Eq3_Figure_output_Rota_Hib_PCV_11Dec2025.Rdata")
load("Scripts - Aim 3/Output/Eq7_Figure_output_Rota_Hib_PCV_11Dec2025.Rdata")


# equation 3
q3 = ggplot(eq3_combined_long_Rota_Hib_PCV, aes(fill=pathogen, x=region, y=median,)) 
...
# equation 7
q7 = ggplot(eq7_combined_long_Rota_Hib_PCV, aes(fill=pathogen, x=region, y=median,)) 
...
ggsave(file="Scripts - Aim 3/Figures/Figure - Weighted Regional Data - Rota - Hib - PCV - Eq3 - Eq7_11Dec2025.pdf",q3_q7,width=15,height=22,dpi=300)
ggsave(file="Scripts - Aim 3/Figures/Figure - Weighted Regional Data - Rota - Hib - PCV - Eq3 - Eq7_11Dec2025.png",q3_q7,width=15,height=22,dpi=300)

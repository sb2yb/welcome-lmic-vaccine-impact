...
# set seed (random.org from 1-1000)
 set.seed(631) # seed set 14 March 24
...
subclinical_gems <- as.data.frame(do.call("rbind", lst))

# save the dataset 
save(subclinical_gems,file="Scripts - Aim 3/Output/subclinical_gems.Rdata")

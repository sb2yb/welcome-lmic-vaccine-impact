# this script will go through all 6 equations for Aim 3
...
# function allows the below code to be used for all_path_all_eq_IHME and all_path_all_eq_DHS dfs created above
...
Eq1_shigella_med_CI <- CI_med_function(df_chunk_1, "Eq1_shigella_lower", "Eq1_shigella_upper", "Eq1_shigella_median")
Eq1_campy_med_CI <- CI_med_function(df_chunk_2, "Eq1_campy_lower", "Eq1_campy_upper", "Eq1_campy_median")
Eq1_ETEC_med_CI <- CI_med_function(df_chunk_3, "Eq1_ETEC_lower", "Eq1_ETEC_upper", "Eq1_ETEC_median")
Eq1_noro_med_CI <- CI_med_function(df_chunk_4, "Eq1_noro_lower", "Eq1_noro_upper", "Eq1_noro_median")
Eq1_rota_med_CI<- CI_med_function(df_chunk_5, "Eq1_rota_lower", "Eq1_rota_upper", "Eq1_rota_median")
Eq1_adeno_med_CI <- CI_med_function(df_chunk_6, "Eq1_adeno_lower", "Eq1_adeno_upper", "Eq1_adeno_median")

Eq2_shigella_med_CI <- CI_med_function(df_chunk_7, "Eq2_shigella_lower", "Eq2_shigella_upper", "Eq2_shigella_median")
Eq2_campy_med_CI <- CI_med_function(df_chunk_8, "Eq2_campy_lower", "Eq2_campy_upper", "Eq2_campy_median")
Eq2_ETEC_med_CI <- CI_med_function(df_chunk_9, "Eq2_ETEC_lower", "Eq2_ETEC_upper", "Eq2_ETEC_median")
Eq2_noro_med_CI <- CI_med_function(df_chunk_10, "Eq2_noro_lower", "Eq2_noro_upper", "Eq2_noro_median")
Eq2_rota_med_CI <- CI_med_function(df_chunk_11, "Eq2_rota_lower", "Eq2_rota_upper", "Eq2_rota_median")
Eq2_adeno_med_CI<- CI_med_function(df_chunk_12, "Eq2_adeno_lower", "Eq2_adeno_upper", "Eq2_adeno_median")

Eq3_shigella_med_CI <- CI_med_function(df_chunk_13, "Eq3_shigella_lower", "Eq3_shigella_upper", "Eq3_shigella_median")
Eq3_campy_med_CI <- CI_med_function(df_chunk_14, "Eq3_campy_lower", "Eq3_campy_upper", "Eq3_campy_median")
Eq3_ETEC_med_CI <- CI_med_function(df_chunk_15, "Eq3_ETEC_lower", "Eq3_ETEC_upper", "Eq3_ETEC_median")
Eq3_noro_med_CI <- CI_med_function(df_chunk_16, "Eq3_noro_lower", "Eq3_noro_upper", "Eq3_noro_median")
Eq3_rota_med_CI <- CI_med_function(df_chunk_17, "Eq3_rota_lower", "Eq3_rota_upper", "Eq3_rota_median")
Eq3_adeno_med_CI <- CI_med_function(df_chunk_18, "Eq3_adeno_lower", "Eq3_adeno_upper", "Eq3_adeno_median")

Eq4_shigella_med_CI <- CI_med_function(df_chunk_19, "Eq4_shigella_lower", "Eq4_shigella_upper", "Eq4_shigella_median")
Eq4_campy_med_CI <- CI_med_function(df_chunk_20, "Eq4_campy_lower", "Eq4_campy_upper", "Eq4_campy_median")
Eq4_ETEC_med_CI <- CI_med_function(df_chunk_21, "Eq4_ETEC_lower", "Eq4_ETEC_upper", "Eq4_ETEC_median")
Eq4_noro_med_CI <- CI_med_function(df_chunk_22, "Eq4_noro_lower", "Eq4_noro_upper", "Eq4_noro_median")
Eq4_rota_med_CI <- CI_med_function(df_chunk_23, "Eq4_rota_lower", "Eq4_rota_upper", "Eq4_rota_median")
Eq4_adeno_med_CI <- CI_med_function(df_chunk_24, "Eq4_adeno_lower", "Eq4_adeno_upper", "Eq4_adeno_median")

Eq5_shigella_med_CI <- CI_med_function(df_chunk_25, "Eq5_shigella_lower", "Eq5_shigella_upper", "Eq5_shigella_median")
Eq5_campy_med_CI <- CI_med_function(df_chunk_26, "Eq5_campy_lower", "Eq5_campy_upper", "Eq5_campy_median")
Eq5_ETEC_med_CI <- CI_med_function(df_chunk_27, "Eq5_ETEC_lower", "Eq5_ETEC_upper", "Eq5_ETEC_median")
Eq5_noro_med_CI <- CI_med_function(df_chunk_28, "Eq5_noro_lower", "Eq5_noro_upper", "Eq5_noro_median")
Eq5_rota_med_CI <- CI_med_function(df_chunk_29, "Eq5_rota_lower", "Eq5_rota_upper", "Eq5_rota_median")
Eq5_adeno_med_CI <- CI_med_function(df_chunk_30, "Eq5_adeno_lower", "Eq5_adeno_upper", "Eq5_adeno_median")

Eq6_shigella_med_CI <- CI_med_function(df_chunk_31, "Eq6_shigella_lower", "Eq6_shigella_upper", "Eq6_shigella_median")
Eq6_campy_med_CI <- CI_med_function(df_chunk_32, "Eq6_campy_lower", "Eq6_campy_upper", "Eq6_campy_median")
Eq6_ETEC_med_CI <- CI_med_function(df_chunk_33, "Eq6_ETEC_lower", "Eq6_ETEC_upper", "Eq6_ETEC_median")
Eq6_noro_med_CI <- CI_med_function(df_chunk_34, "Eq6_noro_lower", "Eq6_noro_upper", "Eq6_noro_median")
Eq6_rota_med_CI <- CI_med_function(df_chunk_35, "Eq6_rota_lower", "Eq6_rota_upper", "Eq6_rota_median")
Eq6_adeno_med_CI <- CI_med_function(df_chunk_36, "Eq6_adeno_lower", "Eq6_adeno_upper", "Eq6_adeno_median")

Eq7_shigella_med_CI <- CI_med_function(df_chunk_37, "Eq7_shigella_lower", "Eq7_shigella_upper", "Eq7_shigella_median")
Eq7_campy_med_CI <- CI_med_function(df_chunk_38, "Eq7_campy_lower", "Eq7_campy_upper", "Eq7_campy_median")
Eq7_ETEC_med_CI <- CI_med_function(df_chunk_39, "Eq7_ETEC_lower", "Eq7_ETEC_upper", "Eq7_ETEC_median")
Eq7_noro_med_CI <- CI_med_function(df_chunk_40, "Eq7_noro_lower", "Eq7_noro_upper", "Eq7_noro_median")
Eq7_rota_med_CI <- CI_med_function(df_chunk_41, "Eq7_rota_lower", "Eq7_rota_upper", "Eq7_rota_median")
Eq7_adeno_med_CI <- CI_med_function(df_chunk_42, "Eq7_adeno_lower", "Eq7_adeno_upper", "Eq7_adeno_median")

Eq8_shigella_med_CI <- CI_med_function(df_chunk_43, "Eq8_shigella_lower", "Eq8_shigella_upper", "Eq8_shigella_median")
Eq8_campy_med_CI <- CI_med_function(df_chunk_44, "Eq8_campy_lower", "Eq8_campy_upper", "Eq8_campy_median")
Eq8_ETEC_med_CI <- CI_med_function(df_chunk_45, "Eq8_ETEC_lower", "Eq8_ETEC_upper", "Eq8_ETEC_median")
Eq8_noro_med_CI <- CI_med_function(df_chunk_46, "Eq8_noro_lower", "Eq8_noro_upper", "Eq8_noro_median")
Eq8_rota_med_CI <- CI_med_function(df_chunk_47, "Eq8_rota_lower", "Eq8_rota_upper", "Eq8_rota_median")
Eq8_adeno_med_CI <- CI_med_function(df_chunk_48, "Eq8_adeno_lower", "Eq8_adeno_upper", "Eq8_adeno_median")

# Bind all of the dfs together (keep all in case they are wanted later, but really only need 1,4,3,6)

all_path_all_eq_med_CI <- cbind(Eq1_shigella_med_CI, Eq1_campy_med_CI, Eq1_ETEC_med_CI, Eq1_noro_med_CI, Eq1_rota_med_CI, Eq1_adeno_med_CI, 
...
return(all_path_all_eq_med_CI)
}

# calling DHS dataframe
all_path_all_eq_med_CI_DHS_DIAR <- df_function(bind)

# save dataframes
write.csv(all_path_all_eq_med_CI_DHS_DIAR, file="Scripts - Aim 3/Output/All_Diarrhea_Pathogens_AllEqs_Med_CI_DHS_24Nov2025.csv")
save(all_path_all_eq_med_CI_DHS_DIAR,file="Scripts - Aim 3/Output/All_Diarrhea_Pathogens_AllEqs_Med_CI_DHS_24Nov2025.Rdata")

...
# set seed (random.org from 1-1000)
 set.seed(450) # seed set 14 March 24
...
subclinical_gems_3_5 <- as.data.frame(do.call("rbind", lst))

# re-order so that the gems sites match the order for the weights
subclinical_gems_3_5 <- subclinical_gems_3_5[,c(2,5,6,4,3,1,7)]

# save the dataset 
save(subclinical_gems_3_5,file="Scripts - Aim 3/Output/subclinical_gems_3_5.Rdata")

# this script will go through ROta, Hib, and PCV pathogens and all equations for Aim 3
...
# vaccine coverage 
coverage <- read.csv("Scripts - Aim 3/vaccine_coverage_Rota_Hib_PCV_ACTUAL.csv")
...
bind <- cbind(Eq1_hib, Eq1_pcv, Eq1_rota,
              Eq2_hib, Eq2_pcv, Eq2_rota,
              Eq3_hib, Eq3_pcv, Eq3_rota,
              Eq4_hib, Eq4_pcv, Eq4_rota,
              Eq5_hib, Eq5_pcv, Eq5_rota,
              Eq6_hib, Eq6_pcv, Eq6_rota,
              Eq7_hib, Eq7_pcv, Eq7_rota,
              Eq8_hib, Eq8_pcv, Eq8_rota)
...
Eq1_rota_med_CI <- CI_med_function(df_chunk_3_mult_weight, "Eq1_rota_lower", "Eq1_rota_upper", "Eq1_rota_median")
...
Eq2_rota_med_CI <- CI_med_function(df_chunk_6_mult_weight, "Eq2_rota_lower", "Eq2_rota_upper", "Eq2_rota_median")
...
Eq3_rota_med_CI <- CI_med_function(df_chunk_9_mult_weight, "Eq3_rota_lower", "Eq3_rota_upper", "Eq3_rota_median")
...
Eq4_rota_med_CI <- CI_med_function(df_chunk_12_mult_weight, "Eq4_rota_lower", "Eq4_rota_upper", "Eq4_rota_median")
...
Eq5_rota_med_CI <- CI_med_function(df_chunk_15_mult_weight, "Eq5_rota_lower", "Eq5_rota_upper", "Eq5_rota_median")
...
Eq6_rota_med_CI <- CI_med_function(df_chunk_18_mult_weight, "Eq6_rota_lower", "Eq6_rota_upper", "Eq6_rota_median")
...
Eq7_rota_med_CI <- CI_med_function(df_chunk_21_mult_weight, "Eq7_rota_lower", "Eq7_rota_upper", "Eq7_rota_median")
...
Eq8_rota_med_CI <- CI_med_function(df_chunk_24_mult_weight, "Eq8_rota_lower", "Eq8_rota_upper", "Eq8_rota_median")

# Bind all of the dfs together (keep all in case they are wanted later, but really only need 1,4,3,6)

hib_pcv_rota_all_eq_med_CI_weighted <-  cbind(Eq1_hib_med_CI, Eq1_pcv_med_CI, Eq1_rota_med_CI, 
                                     Eq2_hib_med_CI, Eq2_pcv_med_CI, Eq2_rota_med_CI, 
                                     Eq3_hib_med_CI, Eq3_pcv_med_CI, Eq3_rota_med_CI,
                                     Eq4_hib_med_CI, Eq4_pcv_med_CI, Eq4_rota_med_CI,
                                     Eq5_hib_med_CI, Eq5_pcv_med_CI, Eq5_rota_med_CI, 
                                     Eq6_hib_med_CI, Eq6_pcv_med_CI, Eq6_rota_med_CI,
                                     Eq7_hib_med_CI, Eq7_pcv_med_CI, Eq7_rota_med_CI, 
                                     Eq8_hib_med_CI, Eq8_pcv_med_CI, Eq8_rota_med_CI)


# save dataframes 
write.csv(hib_pcv_rota_all_eq_med_CI_weighted, file="Scripts - Aim 3/Output/Hib_PCV_Rota_AllEqs_Med_CI_DHS - Weighted by Region_11Dec2025.csv")
save(hib_pcv_rota_all_eq_med_CI_weighted,file="Scripts - Aim 3/Output/Hib_PCV_Rota_AllEqs_Med_CI_DHS - Weighted by Region_11Dec2025.Rdata")

...
Eq1_hib_med_CI <- CI_med_function(df_chunk_1, "Eq1_hib_lower", "Eq1_hib_upper", "Eq1_hib_median")
Eq1_pcv_med_CI <- CI_med_function(df_chunk_2, "Eq1_pcv_lower", "Eq1_pcv_upper", "Eq1_pcv_median")
Eq1_rsv_med_CI <- CI_med_function(df_chunk_3, "Eq1_rsv_lower", "Eq1_rsv_upper", "Eq1_rsv_median")

Eq2_hib_med_CI <- CI_med_function(df_chunk_4, "Eq2_hib_lower", "Eq2_hib_upper", "Eq2_hib_median")
Eq2_pcv_med_CI <- CI_med_function(df_chunk_5, "Eq2_pcv_lower", "Eq2_pcv_upper", "Eq2_pcv_median")
Eq2_rsv_med_CI <- CI_med_function(df_chunk_6, "Eq2_rsv_lower", "Eq2_rsv_upper", "Eq2_rsv_median")

Eq3_hib_med_CI <- CI_med_function(df_chunk_7, "Eq3_hib_lower", "Eq3_hib_upper", "Eq3_hib_median") # figure out how to call chunks 7,8,9 and sum them together and then get med, lower, upper 
Eq3_pcv_med_CI <- CI_med_function(df_chunk_8, "Eq3_pcv_lower", "Eq3_pcv_upper", "Eq3_pcv_median")
Eq3_rsv_med_CI <- CI_med_function(df_chunk_9, "Eq3_rsv_lower", "Eq3_rsv_upper", "Eq3_rsv_median")

Eq4_hib_med_CI <- CI_med_function(df_chunk_10, "Eq4_hib_lower", "Eq4_hib_upper", "Eq4_hib_median")
Eq4_pcv_med_CI <- CI_med_function(df_chunk_11, "Eq4_pcv_lower", "Eq4_pcv_upper", "Eq4_pcv_median")
Eq4_rsv_med_CI <- CI_med_function(df_chunk_12, "Eq4_rsv_lower", "Eq4_rsv_upper", "Eq4_rsv_median")

Eq5_hib_med_CI <- CI_med_function(df_chunk_13, "Eq5_hib_lower", "Eq5_hib_upper", "Eq5_hib_median")
Eq5_pcv_med_CI <- CI_med_function(df_chunk_14, "Eq5_pcv_lower", "Eq5_pcv_upper", "Eq5_pcv_median")
Eq5_rsv_med_CI <- CI_med_function(df_chunk_15, "Eq5_rsv_lower", "Eq5_rsv_upper", "Eq5_rsv_median")

Eq6_hib_med_CI <- CI_med_function(df_chunk_16, "Eq6_hib_lower", "Eq6_hib_upper", "Eq6_hib_median")
Eq6_pcv_med_CI <- CI_med_function(df_chunk_17, "Eq6_pcv_lower", "Eq6_pcv_upper", "Eq6_pcv_median")
Eq6_rsv_med_CI <- CI_med_function(df_chunk_18, "Eq6_rsv_lower", "Eq6_rsv_upper", "Eq6_rsv_median")

Eq7_hib_med_CI <- CI_med_function(df_chunk_19, "Eq7_hib_lower", "Eq7_hib_upper", "Eq7_hib_median") # figure out how to call chunks 7,8,9 and sum them together and then get med, lower, upper 
Eq7_pcv_med_CI <- CI_med_function(df_chunk_20, "Eq7_pcv_lower", "Eq7_pcv_upper", "Eq7_pcv_median")
Eq7_rsv_med_CI <- CI_med_function(df_chunk_21, "Eq7_rsv_lower", "Eq7_rsv_upper", "Eq7_rsv_median")

Eq8_hib_med_CI <- CI_med_function(df_chunk_22, "Eq8_hib_lower", "Eq8_hib_upper", "Eq8_hib_median")
Eq8_pcv_med_CI <- CI_med_function(df_chunk_23, "Eq8_pcv_lower", "Eq8_pcv_upper", "Eq8_pcv_median")
Eq8_rsv_med_CI <- CI_med_function(df_chunk_24, "Eq8_rsv_lower", "Eq8_rsv_upper", "Eq8_rsv_median")

# Bind all of the dfs together (keep all in case they are wanted later, but really only need 1,4,3,6)

all_path_all_eq_med_CI <-      cbind(Eq1_hib_med_CI, Eq1_pcv_med_CI, Eq1_rsv_med_CI, 
...
# calling DHS dataframes
all_path_all_eq_med_CI_DHS_ARI <- df_function(bind)

# save dataframes 
write.csv(all_path_all_eq_med_CI_DHS_ARI, file="Scripts - Aim 3/Output/All_ARI_Pathogens_AllEqs_Med_CI_DHS_24Nov2025.csv")
save(all_path_all_eq_med_CI_DHS_ARI,file="Scripts - Aim 3/Output/All_ARI_Pathogens_AllEqs_Med_CI_DHS_24Nov2025.Rdata")
